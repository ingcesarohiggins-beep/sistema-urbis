...
CREATE TABLE projects (
    ...
    titular_nationality TEXT DEFAULT 'Peruana',
    titular_civil_status TEXT DEFAULT 'Soltera',
    titular_phone TEXT,
    titular_email TEXT,
    titular_office_address TEXT,
    bank_name TEXT,
    bank_account TEXT,
    bank_cci TEXT,
    predio_name TEXT,
    predio_uucc TEXT,
    predio_area TEXT,
    predio_district TEXT,
    predio_partida TEXT,
    predio_zona_registral TEXT,
    late_penalty_rate NUMERIC(10, 2) DEFAULT 1.50,
