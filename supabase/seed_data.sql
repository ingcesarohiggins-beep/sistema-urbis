...
INSERT INTO installments (sale_id, installment_number, due_date, amount, amount_paid, status)
VALUES ('00000000-0000-0000-0000-006700000003', 0, '00:00:00', 0, 0, 'pendiente');
...
INSERT INTO installments (sale_id, installment_number, due_date, amount, amount_paid, status)
VALUES ('00000000-0000-0000-0000-006700000004', 0, '00:00:00', 0, 0, 'pendiente');
...
INSERT INTO installments (sale_id, installment_number, due_date, amount, amount_paid, status)
VALUES ('00000000-0000-0000-0000-007100000004', 0, '00:00:00', 0, 0, 'pendiente');
...
VALUES ('GEN-76322300', 'CRISTHIAN FERNANDO RUIZ SEMINARIO', '51988605281', 'CALLERIA', 'CORONEL PORTILLO', 'UCAYALI')
ON CONFLICT (dni) DO NOTHING;


INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007300000004', '00000000-0000-0000-0000-007300000004', 'GEN-76322300', 19500, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007300000005', '00000000-0000-0000-0000-007300000005', 'GEN-76322300', 16500, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO clients (dni, names, phone, district, province, department)
VALUES ('GEN-62669175', 'BARBARA MELO & ALVARO GUILLERMO DAVILA ESCOBAR', '51903210496', 'CALLERIA', 'CORONEL PORTILLO', 'UCAYALI')
ON CONFLICT (dni) DO NOTHING;


INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007300000007', '00000000-0000-0000-0000-007300000007', 'GEN-62669175', 16500, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO clients (dni, names, phone, district, province, department)
VALUES ('GEN-03307076', 'MARTIN MIGUEL CENTURION GUARDIA', '13106222625', 'CALLERIA', 'CORONEL PORTILLO', 'UCAYALI')
ON CONFLICT (dni) DO NOTHING;


INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007400000005', '00000000-0000-0000-0000-007400000005', 'GEN-03307076', 16500, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007400000006', '00000000-0000-0000-0000-007400000006', 'GEN-03307076', 16500, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO clients (dni, names, phone, district, province, department)
VALUES ('GEN-39314120', 'ELEVI FERNANDEZ DELGADO', '51961396533', 'CALLERIA', 'CORONEL PORTILLO', 'UCAYALI')
ON CONFLICT (dni) DO NOTHING;


INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007600000003', '00000000-0000-0000-0000-007600000003', 'GEN-39314120', 20100, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007600000004', '00000000-0000-0000-0000-007600000004', 'GEN-39314120', 20100, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-007600000005', '00000000-0000-0000-0000-007600000005', 'GEN-39314120', 20100, 500, 48, 'en_proceso')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO clients (dni, names, phone, district, province, department)
VALUES ('GEN-69142489', 'EDWIN ALBERTO SEPULVEDA DELGADO', '91935431633', 'CALLERIA', 'CORONEL PORTILLO', 'UCAYALI')
ON CONFLICT (dni) DO NOTHING;


INSERT INTO sales (id, lot_id, client_id, total_sale_price, initial_amount_paid, installments_count, status)
VALUES ('00000000-0000-0000-0000-006600000002', '00000000-0000-0000-0000-006600000002', 'GEN-69142489', 43500, 500, 48, 'expropiado')
ON CONFLICT (id) DO NOTHING;
